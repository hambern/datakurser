...
### 3. Tekniska Krav
- **Modern CSS Reset:** Lägg in en modern CSS-reset överst i din `style.css` (eller i en separat `reset.css`) för att nollställa marginaler, sätta `box-sizing: border-box` och göra bilder responsiva:
  ```css
  *, *::before, *::after {
