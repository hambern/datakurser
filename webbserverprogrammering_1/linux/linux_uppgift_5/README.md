...
1. Testa och förklara skillnaden på dessa kommandon:
    1. `find ~/../../pers/mh6802/public -name "person"` 
    2. `find ~/../../pers/mh6802/public -name "person*"`
    3. `find ~/../../pers/mh6802/public -name "person.*"`
    4. `find ~/../../pers/mh6802/public -name "person*.*"`
...
4. På min användare `mh6802` finns det i mappen `public` en fil som heter `folk`. Vad händer när du kör kommandot `grep "Sven" ~/../../pers/mh6802/public/folk`?
5. Jämför ovanstående resultat med resultatet av `grep -w "Sven" ~/../../pers/mh6802/public/folk`. Vad är skillnaden?
6. Vad gör kommandot `grep -c "Sven" ~/../../pers/mh6802/public/folk`?
