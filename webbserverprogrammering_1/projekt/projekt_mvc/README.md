...
6. Skapa de filer du behöver. Börja med `index.php` och skapa sedan de filer som behövs för att undvika de felmeddelandendu får. Testa din kod hela tiden via webbläsaren.
