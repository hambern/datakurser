...
8. Om du vill veta hur många det finns av varje valör i en valuta, hur tar du reda på det? Ex på godkänt resultat för kr. Använd `GROUP BY`:
...
9. Om du vill veta hur mycket pengar det finns av valutan Kr. Hur ser frågan ut? Använd `GROUP BY`.