...
1. Skapa en fil i ditt kurs-repository med namnet `sql_uppgift_2.md` i din sql-mapp. I den ska du svara på frågorna nedan.
2. Logga in i MySQL med terminalkommandot: mysql -u student -p -h localhost. Ange lösenordet student när du ombeds göra det. -u står för "user", -p står för att du ska ange lösenord och -h står för "host". Hur kan du med hjälp av mysql-promten ta fram svaren på följande uppgifter? Lös uppgiften och anteckna dina kommandon i `sql_uppgift_2.md`:
    1. (5+3)*14
    2. Värdet av PI
