...
6. Skapa en `.gitigore`-fil som är identisk med [.gitignore](.gitignore). Du kan antingen kopiera innehållet eller ladda ner och använda filen i denna uppgift
7. Pusha upp den kod du skapat, inkl filen `.gitignore` i Programmering 2 till det nya projektet i GitLab
8. När du testat så att du fått med alla filer kan du meddela Daniel via Teams varpå han kan kontrollera att det fungerar.
